package com.thundersoft.app.documentmanager.util.mimeTypeMatch;
...
public final class MimeTypeMatch {
    ...
    public static final String MIME_TYPE_DOCUMENT = "document";
    public static final String MIME_TYPE_DOWNLOAD = "download";
    ...
    public static String getCategoryMimeType(String path) {
        ...
        if (extension != null) {
            ...
            if (type != null) {
                if (type.startsWith(MIME_TYPE_AUDIO)
